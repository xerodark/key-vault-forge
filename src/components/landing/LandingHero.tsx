...
export default function LandingHero() {
  ...
  return (
    <section 
      ref={heroRef}
      className="relative min-h-[85vh] flex items-center justify-center px-4 pt-24 pb-16 md:pb-28 bg-crypto-gray-darker overflow-hidden"
    >
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-4xl text-center space-y-8">
        {/* Logo & headline with glow effect */}
        ...
        {/* Subheadline with animated appearance */}
        ...
        {/* Security badge with subtle animation */}
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce opacity-70">
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 5L12 19" stroke="rgba(251,146,60,0.7)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
          <path d="M19 12L12 19L5 12" stroke="rgba(251,146,60,0.7)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      </div>
