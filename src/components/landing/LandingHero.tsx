...
export default function LandingHero() {
  ...
  return (
    <section 
      ref={heroRef}
      className="relative min-h-[95vh] flex items-center justify-center px-4 pt-24 pb-32 md:pb-44 overflow-hidden"
    >
      {/* Background elements */}
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-[-120px] left-1/2 -translate-x-1/2 w-[1200px] h-[450px] bg-gradient-to-tr from-crypto-orange/30 via-crypto-purple/40 to-crypto-blue/20 blur-[80px] opacity-40 animate-pulse" style={{animationDuration: '10s'}} />
        ...
        <div className="absolute right-[12%] bottom-[15%] w-20 h-20 rounded-full bg-crypto-purple/20 blur-2xl opacity-60 animate-pulse" style={{animationDuration: '7s'}}/>
        <div className="absolute right-[25%] top-[20%] w-12 h-12 rounded-full bg-crypto-blue/20 blur-2xl opacity-50 animate-pulse" style={{animationDuration: '9s'}}/>
      ...
      <div className="relative z-20 flex flex-col items-center w-full max-w-4xl text-center space-y-8">
        <div className="animate-on-scroll opacity-0 translate-y-6 transition-all duration-1000 delay-100">
          <div className="flex flex-row gap-3 items-center justify-center mb-6 relative">
            ...
            <div className="relative">
              ...
              <div className="relative bg-black/20 rounded-full p-2">
        ...
        <h1 className="animate-on-scroll opacity-0 translate-y-6 transition-all duration-1000 delay-200 text-4xl sm:text-5xl md:text-6xl font-extrabold mb-4 leading-tight">
          ...
          <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-crypto-orange via-crypto-purple to-crypto-blue">
            Crypto Investing
          </span>
        </h1>
        ...
        <div className="animate-on-scroll opacity-0 translate-y-6 transition-all duration-1000 delay-400 flex flex-col sm:flex-row gap-4 mb-10 justify-center w-full max-w-md">
          <Button
            size="lg"
            className="glass-card glass-card-hover bg-gradient-to-r from-crypto-orange to-amber-500 hover:shadow-glow-md text-lg shadow-lg shadow-crypto-orange/20 transition-all duration-300 hover:scale-[1.03] w-full sm:w-auto px-8 py-6"
          ...
          <Button
            size="lg"
            variant="outline"
            className="glass border-2 border-glass-border hover:border-crypto-orange/50 hover:bg-glass-light text-lg transition-all duration-300 hover:scale-[1.03] w-full sm:w-auto px-8 py-6"
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 max-w-4xl mx-auto relative z-30 mt-12">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 z-40">
        ...
        <div className="glass mx-auto w-6 h-10 border-glass-border rounded-full flex justify-center p-1">
